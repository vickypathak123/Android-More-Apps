...
import com.example.app.appcenter.autoimageslider.IndicatorView.animation.type.BaseAnimation;
import com.example.app.appcenter.autoimageslider.IndicatorView.animation.type.ColorAnimation;
import com.example.app.appcenter.autoimageslider.IndicatorView.draw.controller.DrawController;
import com.example.app.appcenter.autoimageslider.IndicatorView.draw.data.Orientation;
import com.example.app.appcenter.autoimageslider.IndicatorView.draw.data.RtlMode;
import com.example.app.appcenter.autoimageslider.IndicatorView.utils.DensityUtils;
import com.example.app.appcenter.autoimageslider.InfiniteAdapter.InfinitePagerAdapter;
import com.example.app.appcenter.autoimageslider.Transformations.AntiClockSpinTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.Clock_SpinTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeInDepthTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeInRotationTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeInScalingTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeOutDepthTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeOutRotationTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.CubeOutScalingTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.DepthTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.FadeTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.FanTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.FidgetSpinTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.GateTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.HingeTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.HorizontalFlipTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.PopTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.SimpleTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.SpinnerTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.TossTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.VerticalFlipTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.VerticalShutTransformation;
import com.example.app.appcenter.autoimageslider.Transformations.ZoomOutTransformation;

import static com.example.app.appcenter.autoimageslider.IndicatorAnimations.THIN_WORM;
import static com.example.app.appcenter.autoimageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
public class SliderView extends FrameLayout
    ...
    private void setUpAttributes(@NonNull Context context, AttributeSet attrs) {
        ...
        int indicatorRadius = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorRadius, (DensityUtils.dpToPx(1) + 1));
        int indicatorPadding = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorPadding, DensityUtils.dpToPx(2));
        int indicatorMargin = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMargin, DensityUtils.dpToPx(5));
        ...
        setIndicatorAnimation(THIN_WORM);
    ...
    private void setupSlideView(Context context) {
        ...
        View wrapperView = LayoutInflater.from(context).inflate(R.layout.slider_view, this, true);
